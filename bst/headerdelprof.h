...
/* Inserisce la chiave `k` nel BST `T`. È ammessa la presenza di
   chiavi duplicate, se la chiave è già presente se ne deve inserire
   una nuova copia in un nuovo nodo. */
...
/* Cancella il nodo `n` da `T`. Si assuma che `n` appartenga
   effettivamente a `T`.  */
